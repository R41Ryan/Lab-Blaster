...
public:
	...
	// Checks whether the character will collide with the given hitbox parameters at the given velocities. If it will, it adjusts the positions so that it is merely at the edge of the hitbox and returns true. Returns false otherwise.
